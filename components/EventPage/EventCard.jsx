...
const EventCard = ({ title, description, venue, date, onEdit, onDelete }) => {
  return (
    <motion.div
      ...
      className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-6 mb-4 border border-[#a8738b]/20 hover:border-[#a8738b]/40 transition-all duration-300"
    >
      <div className="flex flex-col space-y-4">
        <div className="flex items-start justify-between">
          <h3 className="text-xl font-semibold text-[#a8738b]">{title}</h3>
